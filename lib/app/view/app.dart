  ...
  void initState() {
    ...
    _timer = Timer(const Duration(milliseconds: 20), () {
      for (var i = 1; i <= 15; i++) {
        ...
        precacheImage(
          Image.asset('assets/images/Coding_club/$i.png').image,
          context,
        );
      }
      precacheImage(
        Image.asset('assets/images/dashatar/gallery/green.jfif').image,
        context,
      );
      precacheImage(
        Image.asset('assets/images/dashatar/success/green.jfif').image,
        context,
      );
      precacheImage(
